    ...
    <div className="bg-white">
      ...
      <header className="bg-gray-800 border-b border-gray-200">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Explora nuestros laboratorios equipados con tecnología de vanguardia para la enseñanza y experimentación en ingeniería eléctrica.
          </motion.p>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* --- Sección Laboratorios Disponibles Animada --- */}
        <motion.section
          className="mb-24"
          initial="hidden"
          whileInView="visible"
          ...
          >
            {[...Array(3)].map((_, i) => (
              <motion.div variants={itemVariants} key={i}>
                <MiniCard                  id={i + 1}                  title="Defensa de tesis"
