  ...
  return (  
    <>  
      ...
      <div className="flex flex-col items-center p-5">  
        ...
        <div className="border-l-4 border-blue-500 bg-gray-50 mt-6 p-4 w-full max-w-4xl">  
        ...
        <div className="bg-white shadow-md rounded-md p-4 m-2 border w-full max-w-4xl mt-4">  
