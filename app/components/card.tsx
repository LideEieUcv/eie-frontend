  ...
  return (
    <div className="bg-white border-2 border-black flex mx-auto overflow-hidden md:max-w-full">
      ...
      <div className="w-1/2 space-y-6 md:w-1/2 my-5 px-8 md:px-8 md:space-y-5">
        ...
        <a href="#" className="text-black font-bold border-2 border-black px-0 md:px-4 py-2 hover:text-gray-500 transition flex flex-shrink flex-grow object-fit w-40">
          Leer artículo →
        </a>
      </div>
    </div>
